...
| `alppy/services/mastery_service.py` | `load_attempt_inputs`, `recompute_for_students`, `class_matrix`, `student_profile`, `competency_attempts` (the drill-down), `band_summary` | `mastery.model`, `models` |
