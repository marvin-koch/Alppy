...
changes: v1 always received an expected answer, or the literal words "(no expected answer was recorded)". v2 takes a `reference` block that either states the expected answer or says none was given, and tells the model what to do in each case.
---
SYSTEM:
...
{"transcription": "...", "written": true, "correct": true, "confidence": 0.0, "reference": "..."}
